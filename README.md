...
- **Customizable Indicators** — Configure each indicator individually to match your strategy
- **Custom Starting Capital** — Set your own initial capital for realistic simulation
- **Flexible Start Date** — Choose any historical start date for your analysis
- **Backtesting Engine** — Run historical backtests on any supported asset and evaluate strategy performance
- **Order Levels Table** — View a detailed breakdown of entry, stop-loss, and take-profit levels
...
1. Clone the repository:
   ```bash
   git clone https://github.com/imang212/Trading_App.git
   ```
...
Feel free to check the [issues page](https://github.com/imang212/Trading_App/issues).
1. Fork the project
