...
public final class AppConfig {
    ...
    static {LinkedHashMap<String, String> a = new LinkedHashMap<>();
        // Commodities & Futures
        a.put("Gold", "GC=F"); a.put("Silver", "SI=F"); a.put("Oil", "CL=F"); a.put("USDIDX", "DX-Y.NYB"); a.put("Brent_Oil", "BZ=F");
        // Forex
        ...
        // Tech
        a.put("MSFT", "MSFT"); a.put("Nokia", "NOKIA.HE"); a.put("Ericsson", "ERIC"); a.put("GOOGL", "GOOGL"); a.put("Apple", "AAPL"); a.put("Tesla", "TSLA"); a.put("Netflix", "NFLX"); a.put("Colt", "CZG.PR"); a.put("CEZ", "CEZ.PR"); a.put("ORCL", "ORCL"); a.put("NVDA", "NVDA"); a.put("AMD", "AMD"); a.put("Adobe", "ADBE"); a.put("Intel", "INTC"); a.put("Spotify", "SPOT"); a.put("Coinbase", "COIN");
        // Defensive
        a.put("Coca-Cola", "KO"); a.put("CocaColaCCH", "CCH.L"); a.put("Altria", "MO"); a.put("Nestle", "NESN.SW"); a.put("AgnicoEagle", "AEM"); a.put("NewmontMining", "NEM"); a.put("NovoNordisk", "NOVO-B.CO"); a.put("Moneta", "MONET.PR"); a.put("KomBanka", "KOMB.PR"); a.put("UBS", "UBSG.SW"); a.put("Zurrich_Insurance", "ZURN.SW"); a.put("Nordea_Bank", "NDA-FI.HE"); a.put("British_American_Tobacco", "BTI"); a.put("Equinor", "EQNR"); a.put("Allianz", "ALV.DE"); a.put("Procter&Gamble", "PG");
        ASSETS = Collections.unmodifiableMap(a);
        // Profile assignments
        Map<String, String> p = new HashMap<>();
        p.put("Gold","COMMODITY"); p.put("Silver","COMMODITY"); p.put("Oil","COMMODITY");
        p.put("Brent_Oil","COMMODITY"); p.put("USDIDX","FOREX_IDX");
        ...
        p.put("SP500","DEFENSIVE"); p.put("MSCIWorld","DEFENSIVE"); p.put("Nasdaq100","DEFENSIVE");
        p.put("MSFT","TECH"); p.put("Nokia","TECH"); p.put("Ericsson","TECH");
